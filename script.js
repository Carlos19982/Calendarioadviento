document.addEventListener('DOMContentLoaded', () => {
    ...
    const regalos = [
        ...
        { dia: 5, text: "Un recuerdo especial 📸", img: "imagenes/dia5.png" },
        { dia: 6, text: "Un recuerdo especial 📸", img: "imagenes/dia6.jpg" },
        { dia: 7, text: "Un recuerdo especial 📸", img: "imagenes/dia7.jpg" },
        { dia: 8, text: "Churros navideños 🍩" },
        { dia: 9, text: "Vale por un paseo navideño para ver las luces del centro (y comer heladico 🍦)" },
        { dia: 10, text: "Un recuerdo especial 📸", img: "imagenes/dia10.jpg" },
        { dia: 11, text: "Un recuerdo especial 📸", img: "imagenes/dia11.jpg" },
        ...
        {dia: 16, text: "Elige para ver Mario Bros la Pelicula o Como entrenar a tu Dragon linda 🐲"},
